<template>
                  ...
                  <div class="w-full flex mb-4 p-2 justify-end">
                    <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                      <div class="p-1 flex items-center">
                          <label for="tmdb_number_e" class="block text-sm font-medium text-gray-700 mr-4">Episode Number</label>
                          <div class="relative rounded-md shadow-sm">
                              <input v-model="episodeNumber" id="tmdb_number_e" name="tmdb_number_e"
                  ...
                  <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                    ...
                    <div class="w-full overflow-x-auto">
                        ...
                        <TableRow v-for="episode in episodes.data" :key="episode.id">
                          ...
                          <TableData>
                            <div class="flex justify-around">
                              ...
                              <ButtonLink class="bg-red-500 hover:bg-red-700" :method="'delete'" :link="route('admin.episodes.destroy', [tvShow.id, season.id, episode.id])">Delete</ButtonLink>
                            </div>
                          </TableData>
                        </TableRow>
                      </Table>
                      ...
                      <div class="p-4 bg-white">
                        <Pagination :links="episodes.links"></Pagination>
                      </div>
                    </div>
                  </div>
                </section>
  ...
  <script setup>
    ...
    watch(search, (value) => {
        router.get('/admin/tv-shows/' + props.tvShow.id + '/season/' + props.season.id + '/episodes', 
                    {
                      search: value,
    ...
    const getepisodes = () => {
      ...
      router.get('/admin/tv-shows/' + props.tvShow.id + '/seasons/' . props.season.id + '/episodes', 
                    {
                      perPage: perPage.value,
                      search: search.value
                    },
