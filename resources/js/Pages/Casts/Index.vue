                      ...
                      <TableRow v-for="cast in casts.data" :key="cast.id">
                        ...
                        <TableData>
                          <div class="flex justify-around">
                            ...
                            <ButtonLink class="bg-red-500 hover:bg-red-700" :method="'delete'" :link="route('admin.casts.destroy', cast.id)">Delete</ButtonLink>
                          </div>
                        </TableData>
                      </TableRow>
                    </Table>
