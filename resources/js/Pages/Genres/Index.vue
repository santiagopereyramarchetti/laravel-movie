                ...
                <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                  ...
                  <div class="w-full overflow-x-auto">
                      ...
                      <TableRow v-for="genre in genres.data" :key="genre.id">
                        ...
                        <TableData>
                          <div class="flex justify-around">
                            ...
                            <ButtonLink class="bg-red-500 hover:bg-red-700" :method="'delete'" :link="route('admin.genres.destroy', genre.id)">Delete</ButtonLink>
                          </div>
                        </TableData>
                      </TableRow>
                    </Table>
                    ...
                    <div class="p-4 bg-white">
                      <Pagination :links="genres.links"></Pagination>
                    </div>
                  </div>
                </div>
              </section>
